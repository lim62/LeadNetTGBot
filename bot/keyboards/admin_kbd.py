...
def get_accounts_kbd(i18n: TranslatorRunner) -> InlineKeyboardMarkup:
    ...
    keyboard.append([InlineKeyboardButton(text=i18n.btn.recieve_code(), callback_data='recieve_code')])
